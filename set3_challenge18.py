...
if __name__ == '__main__':
    ...
    test_text = 'L77na/nrFsKvynd6HzOoG7GHTLXsTVu9qvY/2syLXzhPweyyMTJULu/6/kXX0KSvoOLSFQ=='
    test_bytes = b64decode(test_text)
    # nonce = b'\x00'*8
    nonce = 0
    msg = encrypt_aes_ctr(test_bytes, key, nonce)
